  ...
  projects: {
    ...
    array: [
      ...
      },
      {
        id: "p3",
        title: "CourseTube-V1",
        liveDeom: "https://deiahamad.github.io/Project-3-CourseTube/",
        github: "https://github.com/DeiaHamad/Project-3-CourseTube",
        technology: [
          {
            lang: "Html",
            icon: <IoLogoHtml5 className="project-icon" />,
...
function handleExperience() {
  ...
  const startingDate = new Date("2021-11-1");
  ...
  const expInMonths =
    currentDateMonth +
    12 * currentDateYear -
    (startingDateMonth + 12 * startingDateYear);
